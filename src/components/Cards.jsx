...
const Cards = ({ breweries }) => (
  <div className="flex items-center justify-center lg:flex-row flex-wrap ">
    {breweries.slice(0).map((brewery, index) => (
      <div key={index} className=" m-10">
        <Card className="w-full h-[550px]  max-w-[26rem] shadow-lg hover:scale-105 duration-300">
          <CardHeader floated={false} color="blue-gray">
            <img src="src/assets/Card-img-1.jpg" alt="ui/ux review check" />
          ...
          <CardBody>
            ...
            >
              <span className="flex items-center">
                <FaTreeCity size={20} color="#81b29a" className="mr-2" />
                {brewery.city ? `${brewery.city}` : "Not available"}
              </span>
              <span className="flex items-center">
                <SiHomebrew size={20} color="#81b29a" className="mr-2" />
